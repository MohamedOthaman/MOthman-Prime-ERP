            ...
            <header className="sticky top-0 z-10 bg-background/95 backdrop-blur border-b border-border px-4 py-3">
                <div className="max-w-3xl mx-auto">
                    <div className="flex items-center gap-2 mb-3">
                        ...
                        <h1 className="text-lg font-medium text-foreground">{t("pageTitleCustomers", "Customers")}</h1>
                    ...
                    <div className="relative">
                        ...
                        <input
                            type="text"
                            placeholder={t("customersSearch", "Search by name, code, or Arabic name...")}
                            value={search}
            ...
            <main className="max-w-3xl mx-auto px-4 py-4 space-y-2">
                ...
                {!loading && filtered.length === 0 && (
                    <div className="text-center py-16 text-muted-foreground">
                        ...
                        <p className="text-sm">{t("noCustomersFound", "No customers found")}</p>
                    </div>
                )}
                            ...
                            <div className="flex items-start justify-between gap-2">
                                <div className="min-w-0">
                                    ...
                                    <div className="flex items-center gap-3 flex-wrap">
                                        ...
                                        <span className="text-xs text-muted-foreground">
                                            {customer.credit_days}{t("creditDaysSuffix", "d credit")}
                                        </span>
                                    </div>
                                </div>
