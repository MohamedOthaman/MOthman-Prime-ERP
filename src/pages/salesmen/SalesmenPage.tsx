            ...
            <header className="sticky top-0 z-10 bg-background/95 backdrop-blur border-b border-border px-4 py-3">
                <div className="max-w-3xl mx-auto">
                    <div className="flex items-center gap-2 mb-3">
                        ...
                        <h1 className="text-lg font-medium text-foreground">{t("pageTitleSalesmen", "Salesmen")}</h1>
                    ...
                    <div className="relative">
                        ...
                        <input
                            type="text"
                            placeholder={t("salesmenSearch", "Search by name, code, or Arabic name...")}
                            value={search}
            ...
            <main className="max-w-3xl mx-auto px-4 py-4 space-y-2">
                ...
                {!loading && filtered.length === 0 && (
                    <div className="text-center py-16 text-muted-foreground">
                        ...
                        <p className="text-sm">{t("noSalesmenFound", "No salesmen found")}</p>
                    </div>
                )}
